...
urlpatterns = [
    ...
    path('create_and_start_cvm/', create_and_start_cvm, name='create_and_start_cvm'),
    path('stop_cvm/', stop_cvm, name='stop_cvm'),
    path('check_cvm/', check_cvm, name='check_cvm'),
    path('update_cvm/', update_cvm, name='update_cvm'),
    path('start_cvm/', start_cvm, name='start_cvm'),
    path('delete_cvm/', delete_cvm, name='delete_cvm'),
    ]